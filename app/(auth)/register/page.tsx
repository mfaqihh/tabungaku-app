...
import { LuMail, LuLock, LuUser, LuUserPlus, LuEye, LuEyeOff } from "react-icons/lu";
import {
  AuthCard,
  AuthHeader,
  FormInput,
  ...
  return (
    <AuthCard>
      <AuthHeader
        ...
        subtitle="Daftar untuk mulai mengelola tabungan Anda"
      />
            ...
            >
              ...
              <Checkbox.Label>
                <Text fontSize="sm" color="gray.600" _dark={{ color: "gray.400" }}>
                  Saya menyetujui{" "}
                  <Text as="span" color="teal.600" fontWeight="medium" _dark={{ color: "teal.400" }}>
